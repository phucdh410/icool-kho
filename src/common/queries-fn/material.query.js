...
export const getAllTransfers = (params, isLoading = false, options = {}) =>
  createQuery(["transfers", params], () => api.getAllTransfers(params), {
    enabled: !isLoading,
    ...options,
  });

export const getTransferById = (id, isLoading, options = {}) =>
  createQuery(["tranasfer-detail", id], () => api.getTransferById(id), {
    enabled: !isLoading,
    ...options,
  });
