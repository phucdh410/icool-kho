...
export const getPreview = async (code, store_code) =>
  await map(({ data }) => new PurchaseSlipPreview(data)).get(
    `${PURCHASE_SLIP.getPreview}/${code}?store_code=${store_code}`
  );
