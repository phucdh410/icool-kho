...
const navigation = [
  ...
  //#region Nhà cung cấp
  {
    ...
    childrens: [
      DeXuatNhaCungCap.DanhSachDeXuatNhaCungCap.path,
      DeXuatNhaCungCap.ThemDeXuatNhaCungCap.path,
      NhaCungCap.DanhSachPhieuChamDiemNhaCungCap.path,
      NhaCungCap.ThemPhieuChamDiemNhaCungCap.path,
    ],
    _children: [
      {
        _tag: "CSidebarNavItem",
        name: DeXuatNhaCungCap.DanhSachDeXuatNhaCungCap.name,
        to: DeXuatNhaCungCap.DanhSachDeXuatNhaCungCap.path,
        childrens: [DeXuatNhaCungCap.DanhSachDeXuatNhaCungCap.path],
        required: [{ code: ENTITY_GROUP_CODE.MATERIAL_GROUP }],
      },
      {
        _tag: "CSidebarNavItem",
        name: DeXuatNhaCungCap.ThemDeXuatNhaCungCap.name,
        to: DeXuatNhaCungCap.ThemDeXuatNhaCungCap.path,
        childrens: [DeXuatNhaCungCap.ThemDeXuatNhaCungCap.path],
        required: [{ code: ENTITY_GROUP_CODE.MATERIAL_GROUP }],
      },
      {
        _tag: "CSidebarNavItem",
        name: NhaCungCap.DanhSachPhieuChamDiemNhaCungCap.name,
        to: NhaCungCap.DanhSachPhieuChamDiemNhaCungCap.path,
        childrens: [NhaCungCap.DanhSachPhieuChamDiemNhaCungCap.path],
        required: [{ code: ENTITY_GROUP_CODE.MATERIAL_GROUP }],
      },
      {
        _tag: "CSidebarNavItem",
