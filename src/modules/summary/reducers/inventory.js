...
export const NAME = "SUMMARY_INVENTORY";
...
function summaryInventoryReducer(
	state = initialState,
...
export default persistReducer(persistConfig, summaryInventoryReducer);
