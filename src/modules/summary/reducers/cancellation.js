...
export const NAME = "SUMMARY_CANCELLATION";
...
function summaryCancellationReducer(
	state = initialState,
...
export default persistReducer(persistConfig, summaryCancellationReducer);
