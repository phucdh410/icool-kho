...
export const NAME = "SUMMARY_INVENTORY_ADJUSTMENT";
...
const persistConfig = {
	key: "_summary_inventory_adjustment",
	storage: storage,
	blacklist: ["code"],
...
function summaryInventoryAdjustmentReducer(
	state = initialState,
...
export default persistReducer(persistConfig, summaryInventoryAdjustmentReducer);
