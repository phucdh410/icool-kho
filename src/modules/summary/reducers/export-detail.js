...
export const NAME = "SUMMARY_EXPORT_DETAIL";
...
function summaryExportDetailReducer(
	state = initialState,
...
export default persistReducer(persistConfig, summaryExportDetailReducer);
