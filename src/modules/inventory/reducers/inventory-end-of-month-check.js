...
export const NAME = "INVENTORY_END_OF_MONTH_CHECK";
...
const persistConfig = {
  key: "_inventory_end_of_month_check",
  storage: storage,
  blacklist: ["code"],
...
function inventoryCheckReducer(
  state = initialState,
...
export default persistReducer(persistConfig, inventoryCheckReducer);
