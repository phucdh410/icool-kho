...
export const NAME = "PURCHASE_PROPOSAL_FORM_PRINT";
...
const persistConfig = {
	key: "_purchase_proposal_form_print",
	storage: storage,
	blacklist: ["code"],
...
function purchaseProposalFormPrintReducer(
	state = initialState,
...
export default persistReducer(persistConfig, purchaseProposalFormPrintReducer);
