...
import { getAll } from "_common/queries-fn/purchase-proposal-form.query";

import MPrintDialog from "../../components/PrintDialog";
import MPrintByGroupDialog from "../../components/PrintDialog/PrintByGroup";
import { NAME } from "../../reducers/purchase-proposal-form-print";
...
const selectData = createSelector(
	(state) => state.config,
	(state) => state.purchaseProposalFormPrint,
	({ isLoading }, { filters }) => ({ isLoading, filters })
);

const PurchaseProposalFormPrint = ({}) => {
...
export default PurchaseProposalFormPrint;
